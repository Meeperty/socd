...
{
    public class MainWindowViewModel : ViewModelBase, INotifyPropertyChanged, IDisposable
    {
        #region properties
...
#pragma warning restore CS0108 // Member hides inherited member; missing new keyword
        ...
        public void OnDBBindingPropertyChange(object? o, PropertyChangedEventArgs e)
        {
            if (e.PropertyName == "CodeString")
                disableBind = ((KeyBindDataBindings)o).Bind;
        }

        public KeyBindDataBindings leftBinding = new();
        public KeyBindDataBindings LeftBinding
        {
            get { return leftBinding; }
        }
        public void OnLeftBindingPropertyChange(object? o, PropertyChangedEventArgs e)
        {
            if (e.PropertyName == "CodeString")
                customBinds[(int)KEY.LEFT] = ((KeyBindDataBindings)o).Bind;
        }

        public KeyBindDataBindings rightBinding = new();
        public KeyBindDataBindings RightBinding
        {
            get { return rightBinding; }
        }
        public void OnRightBindingPropertyChange(object? o, PropertyChangedEventArgs e)
        {
            if (e.PropertyName == "CodeString")
                customBinds[(int)KEY.RIGHT] = ((KeyBindDataBindings)o).Bind;
        }

        public KeyBindDataBindings upBinding = new();
        public KeyBindDataBindings UpBinding
        {
            get { return upBinding; }
        }
        public void OnUpBindingPropertyChange(object? o, PropertyChangedEventArgs e)
        {
            if (e.PropertyName == "CodeString")
                customBinds[(int)KEY.UP] = ((KeyBindDataBindings)o).Bind;
        }

        public KeyBindDataBindings downBinding = new();
        public KeyBindDataBindings DownBinding
        {
            get { return downBinding; }
        }
        public void OnDownBindingPropertyChange(object? o, PropertyChangedEventArgs e)
        {
            if (e.PropertyName == "CodeString")
                customBinds[(int)KEY.DOWN] = ((KeyBindDataBindings)o).Bind;
        }
        ...
        public MainWindowViewModel()
        {
            ...
            rightBinding.PropertyChanged += OnRightBindingPropertyChange;
            upBinding.PropertyChanged += OnUpBindingPropertyChange;
            downBinding.PropertyChanged += OnDownBindingPropertyChange;
        ...
        {
            currentBinds[0] = bindings[0];
            currentBinds[1] = bindings[1];
            currentBinds[2] = bindings[2];
            currentBinds[3] = bindings[3];
            disableBind = db;
        }
        ...
        void ReadSettings(string path)
        {
            ...
            finally
            {
                ...
                LeftBinding.CodeString = binds[(int)KEY.LEFT].ToString("X");
                RightBinding.CodeString = binds[(int)KEY.RIGHT].ToString("X");
                UpBinding.CodeString = binds[(int)KEY.UP].ToString("X");
                DownBinding.CodeString = binds[(int)KEY.DOWN].ToString("X");

                disableBind = db;
                DBBinding.CodeString = db.ToString("X");
        ...
        {
            if (key == currentBinds[(int)KEY.LEFT])
                return currentBinds[(int)KEY.RIGHT];
            else if (key == currentBinds[(int)KEY.RIGHT])
                return currentBinds[(int)KEY.LEFT];
            else if (key == currentBinds[(int)KEY.UP])
                return currentBinds[(int)KEY.DOWN];
            else if (key == currentBinds[(int)KEY.DOWN])
                return currentBinds[(int)KEY.UP];
            else
                return 0;
        }
